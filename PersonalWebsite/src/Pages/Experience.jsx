                ...
                <ExpCard
                    ...
                    desc={
                        <ul className="ps-5 mt-2 space-y-1 list-disc list-inside">
                            ...
                            <li>Completed 4 projects utilizing the Symbols in-development framework DOMQL to create reusable components and pages to be available on company platform</li>
