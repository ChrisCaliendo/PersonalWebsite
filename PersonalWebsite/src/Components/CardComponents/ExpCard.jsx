    ...
    return ( 
        <div className=" p-2 grid grid-cols-1 grid-rows-1 gap-0 place-content-center h-full">
            <div className="flex flex-col">
                <div className={`flex px-3 pr-6 py-2 border-slate-800 bg-slate-200 col-span-1 h-fit justify-between rounded-t-2xl `}>
                    ...
                    <div className="flex aspect-[1/1] max-w-24 xs:max-w-32 xs:min-w-32 sm:max-w-40 sm:min-w-40">
